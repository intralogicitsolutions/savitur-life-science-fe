      ...
      <div className="mx-auto h-[931px] min-h-[931px] w-[354px] max-w-[354px] sm:h-[648px] sm:min-h-0 sm:max-h-none sm:w-full sm:max-w-[1164px] sm:overflow-visible">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between lg:gap-16">
          ...
          <div className="inline-flex h-auto min-h-[36px] w-fit max-w-full flex-row items-center rounded-full border border-[rgba(0,0,0,0.1)] bg-white px-[12px] py-[6px] shadow-[0_6px_16px_rgba(15,23,42,0.06)] sm:h-[36px] sm:w-[232px]">
              ...
              <span
                className="font-sora font-normal text-[12px] leading-[100%] tracking-[-0.04em] text-[#000000] sm:text-[16px] [text-shadow:2px_2px_0_#0000000F]"
            ...
            <h2 className="[text-shadow:2px_2px_0_#0000000F] h-auto w-full max-w-full font-sora font-normal text-[26px] leading-[120%] tracking-[-0.02em] text-[#000000] !mt-[12px] min-[1600px]:!mt-[16px] sm:h-[150px] sm:w-[574px] sm:text-[40px]"
          ...
          <p className="h-auto w-full pt-[8px] font-semibold text-[14px] leading-[150%] tracking-[-0.02em] text-[#4D4D4D] sm:pt-[80px] sm:h-[150px] sm:w-[472px] sm:text-[16px] [text-shadow:2px_2px_0_#0000000F]"
          >
          ...
          {categories.map((item) => (
            ...
            >
              <div className="flex flex-col">
                ...
                <h3
                  className="font-manrope font-semibold sm:text-[24px] text-[16px] leading-[100%] tracking-[-0.04em] text-[#111827] [text-shadow:2px_2px_0_#0000000F]"
                >
                  {item.title}
                </h3>
              </div>
