    ...
    <section className="w-full bg-white flex justify-center">
      <div className="w-full max-w-[1164px] h-[634px] mx-auto py-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-16 mb-12 lg:mb-16">
          ...
          <div className="inline-flex flex-row items-center gap-1 px-3 py-1.5 h-[36px] w-[240px] rounded-full border border-[rgba(0,0,0,0.1)] bg-white shadow-[0_6px_16px_rgba(15,23,42,0.06)]">
            ...
            <h2 className="w-[574px] h-[100px] font-sora font-normal text-[40px] leading-[120%] tracking-[-0.04em] text-[#000000]"
             style={{ textShadow: '2px 2px 0 rgba(0,0,0,0.06)' }}
            >
          ...
          <p className="pt-[80px] w-[472px] h-[100px] font-manrope font-semibold text-[16px] leading-[150%] tracking-[-0.02em] align-middle text-[#4D4D4D]"
             style={{ textShadow: '2px 2px 0 rgba(0,0,0,0.06)' }}
          >
        ...
        {/* Bottom CTA row */}
        <div className="flex items-center justify-center gap-4 w-[408px] h-[48px] mx-auto rounded-full">
          <button
            type="button"
          ...
          <button
            type="button"
            className="inline-flex items-center gap-2 font-sora font-semibold text-[16px] leading-[100%] tracking-[-0.02em] bg-gradient-to-r from-[#FF8C42] to-[#E65C00] text-transparent bg-clip-text underline"
          >
